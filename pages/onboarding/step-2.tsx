...
export default function OnboardingStepTwo() {
  ...
  return (
    <OnBoardingLayout nextBgColor={primary2} bgColor={primary1} nextHref="(onboarding)/step-3">
      <View style={generalStyles.container}>
        <View style={generalStyles.textContainer}>
          <Text style={[generalStyles.text, generalStyles.titleBold]}>Expo Router Navigation</Text>
